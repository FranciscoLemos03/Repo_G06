...
@Composable
fun EditBeneficiarioPage(beneficiarioID: String, navController: NavController, authViewModel: AuthViewModel){
    ...
    Surface(
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    onClick = { navController.navigate("beneficiario/${beneficiarioID}") },
            ...
            DynamicButton(
                ...
                onClick = {
                    if(isValid){
                        firestoreViewModel.updateBeneficiarioDetails(beneficiarioID, nome, telemovel, nacionalidade)
                        Toast.makeText(
                            context,
                            "Beneficiario atualizado com sucesso",
                            Toast.LENGTH_SHORT
                        ).show()
                        navController.navigate("beneficiario/${beneficiarioID}")
                    } else {
                        Toast.makeText(
                            context,
